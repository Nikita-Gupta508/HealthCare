...
import adminProfile from "../../assets/adminimage.jpg";
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="w-full text-center  h-[80px] p-2">
          <button
            ...
            className="bg-black text-white rounded-full text-md font-medium p-2 px-5 cursor-pointer hover:scale-110 duration-200 active:scale-90 "
          >
            Sign Out
          </button>
        </div>
