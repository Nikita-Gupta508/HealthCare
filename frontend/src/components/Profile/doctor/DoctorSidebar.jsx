...
const DoctorSidebar = ({ profilePic, userName }) => {
  ...
  return (
    ...
    <div className='w-full text-center  h-[80px] p-2 '>
        <button onClick={handleSignOut} className='bg-black text-white rounded-full text-md font-medium px-5 p-2 cursor-pointer hover:scale-110 duration-200 active:scale-90 '>Sign Out</button>
    </div>
</div>
  );
};
